...
_gpupgrade_apply()
{
    ...
    local_nonpersistent_flags+=("--log-dir")
    local_nonpersistent_flags+=("--log-dir=")
    flags+=("--phase=")
...
_gpupgrade_execute()
{
    ...
    local_nonpersistent_flags+=("--?")
    local_nonpersistent_flags+=("-?")
    flags+=("--parent-backup-dir=")
    two_word_flags+=("--parent-backup-dir")
    local_nonpersistent_flags+=("--parent-backup-dir")
    local_nonpersistent_flags+=("--parent-backup-dir=")
    flags+=("--pg-upgrade-verbose")
    local_nonpersistent_flags+=("--pg-upgrade-verbose")
    flags+=("--verbose")
    flags+=("-v")
