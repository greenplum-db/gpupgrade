...
type InitializeRequest struct {
	...
	Mode                 Mode     `protobuf:"varint,5,opt,name=mode,proto3,enum=idl.Mode" json:"mode,omitempty"`
...
func (m *InitializeRequest) GetMode() Mode {
	if m != nil {
		return m.Mode
	}
...
type FinalizeRequest struct {
	NonInteractive       bool     `protobuf:"varint,1,opt,name=nonInteractive,proto3" json:"nonInteractive,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *FinalizeRequest) GetNonInteractive() bool {
	if m != nil {
...
func (m *RevertRequest) GetNonInteractive() bool {
	if m != nil {
		return m.NonInteractive
	}
	return false
...
var fileDescriptor_631e66a01873be02 = []byte{
	...
	,
}
