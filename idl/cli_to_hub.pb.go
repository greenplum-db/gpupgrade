...
func (UpgradeSteps) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_5ea794af5812f6af, []int{0}
}
...
func (StepStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_5ea794af5812f6af, []int{1}
}
...
func (Chunk_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_5ea794af5812f6af, []int{20, 0}
}
...
func (*ExecuteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_5ea794af5812f6af, []int{2}
}
...
func (*FinalizeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_5ea794af5812f6af, []int{3}
}
...
func (*FinalizeReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_5ea794af5812f6af, []int{4}
}
...
func (*StatusConversionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_5ea794af5812f6af, []int{5}
}
...
func (*PrimaryStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_5ea794af5812f6af, []int{6}
}
...
func (*StatusConversionReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_5ea794af5812f6af, []int{7}
}
...
func (*StatusUpgradeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_5ea794af5812f6af, []int{8}
}
...
func (*StatusUpgradeReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_5ea794af5812f6af, []int{9}
}
...
func (*UpgradeStepStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_5ea794af5812f6af, []int{10}
}
...
func (*CountPerDb) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_5ea794af5812f6af, []int{11}
}
...
func (*CheckObjectCountRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_5ea794af5812f6af, []int{12}
}
...
func (*CheckObjectCountReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_5ea794af5812f6af, []int{13}
}
...
func (*CheckVersionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_5ea794af5812f6af, []int{14}
}
...
func (*CheckVersionReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_5ea794af5812f6af, []int{15}
}
...
func (*CheckDiskSpaceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_5ea794af5812f6af, []int{16}
}
...
func (*CheckDiskSpaceReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_5ea794af5812f6af, []int{17}
}
...
func (*PrepareInitClusterRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_5ea794af5812f6af, []int{18}
}
...
func (*PrepareInitClusterReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_5ea794af5812f6af, []int{19}
}
...
func (*Chunk) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_5ea794af5812f6af, []int{20}
}
...
type UpgradeMessage struct {
	...
	//	*UpgradeMessage_Chunk
	//	*UpgradeMessage_Status
	Contents             isUpgradeMessage_Contents `protobuf_oneof:"contents"`
	XXX_NoUnkeyedLiteral struct{}                  `json:"-"`
	XXX_unrecognized     []byte                    `json:"-"`
	XXX_sizecache        int32                     `json:"-"`
}

func (m *UpgradeMessage) Reset()         { *m = UpgradeMessage{} }
func (m *UpgradeMessage) String() string { return proto.CompactTextString(m) }
func (*UpgradeMessage) ProtoMessage()    {}
func (*UpgradeMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_5ea794af5812f6af, []int{21}
}
func (m *UpgradeMessage) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_UpgradeMessage.Unmarshal(m, b)
}
func (m *UpgradeMessage) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_UpgradeMessage.Marshal(b, m, deterministic)
}
func (dst *UpgradeMessage) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpgradeMessage.Merge(dst, src)
}
func (m *UpgradeMessage) XXX_Size() int {
	return xxx_messageInfo_UpgradeMessage.Size(m)
}
func (m *UpgradeMessage) XXX_DiscardUnknown() {
	xxx_messageInfo_UpgradeMessage.DiscardUnknown(m)
}

var xxx_messageInfo_UpgradeMessage proto.InternalMessageInfo

type isUpgradeMessage_Contents interface {
	isUpgradeMessage_Contents()
}

type UpgradeMessage_Chunk struct {
	Chunk *Chunk `protobuf:"bytes,1,opt,name=chunk,oneof"`
}
type UpgradeMessage_Status struct {
	Status *UpgradeStepStatus `protobuf:"bytes,2,opt,name=status,oneof"`
}

func (*UpgradeMessage_Chunk) isUpgradeMessage_Contents()  {}
func (*UpgradeMessage_Status) isUpgradeMessage_Contents() {}

func (m *UpgradeMessage) GetContents() isUpgradeMessage_Contents {
	if m != nil {
		return m.Contents
	}
	return nil
...
func (m *UpgradeMessage) GetChunk() *Chunk {
	if x, ok := m.GetContents().(*UpgradeMessage_Chunk); ok {
		return x.Chunk
	}
	return nil
}

func (m *UpgradeMessage) GetStatus() *UpgradeStepStatus {
	if x, ok := m.GetContents().(*UpgradeMessage_Status); ok {
		return x.Status
	}
	return nil
}
...
func (*UpgradeMessage) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _UpgradeMessage_OneofMarshaler, _UpgradeMessage_OneofUnmarshaler, _UpgradeMessage_OneofSizer, []interface{}{
		(*UpgradeMessage_Chunk)(nil),
		(*UpgradeMessage_Status)(nil),
	}
}

func _UpgradeMessage_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*UpgradeMessage)
	// contents
	switch x := m.Contents.(type) {
	case *UpgradeMessage_Chunk:
		b.EncodeVarint(1<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Chunk); err != nil {
			return err
		}
	case *UpgradeMessage_Status:
	...
	case nil:
	default:
		return fmt.Errorf("UpgradeMessage.Contents has unexpected type %T", x)
	}
	return nil
}

func _UpgradeMessage_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*UpgradeMessage)
	switch tag {
	case 1: // contents.chunk
		...
		m.Contents = &UpgradeMessage_Chunk{msg}
		return true, err
	case 2: // contents.status
		...
		err := b.DecodeMessage(msg)
		m.Contents = &UpgradeMessage_Status{msg}
		return true, err
	default:
		return false, nil
	}
...
func _UpgradeMessage_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*UpgradeMessage)
	// contents
	switch x := m.Contents.(type) {
	case *UpgradeMessage_Chunk:
...
func (*SetConfigRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_5ea794af5812f6af, []int{22}
}
...
func (*SetConfigReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_5ea794af5812f6af, []int{23}
}
...
func (*GetConfigRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_5ea794af5812f6af, []int{24}
}
...
func (*GetConfigReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_5ea794af5812f6af, []int{25}
}
...
func init() {
	...
	proto.RegisterType((*UpgradeMessage)(nil), "idl.UpgradeMessage")
...
func (x *cliToHubExecuteClient) Recv() (*UpgradeMessage, error) {
	m := new(UpgradeMessage)
...
func (x *cliToHubExecuteServer) Send(m *UpgradeMessage) error {
...
func init() { proto.RegisterFile("cli_to_hub.proto", fileDescriptor_cli_to_hub_5ea794af5812f6af) }

var fileDescriptor_cli_to_hub_5ea794af5812f6af = []byte{
	...
	,
}
