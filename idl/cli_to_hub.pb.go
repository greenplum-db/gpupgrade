...
func (UpgradeSteps) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_f0d72079fb740885, []int{0}
}
...
func (StepStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_f0d72079fb740885, []int{1}
}
...
func (Chunk_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_f0d72079fb740885, []int{20, 0}
}
...
func (*ExecuteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_f0d72079fb740885, []int{2}
}
...
func (*FinalizeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_f0d72079fb740885, []int{3}
}
...
func (*FinalizeReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_f0d72079fb740885, []int{4}
}
...
func (*StatusConversionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_f0d72079fb740885, []int{5}
}
...
func (*PrimaryStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_f0d72079fb740885, []int{6}
}
...
func (*StatusConversionReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_f0d72079fb740885, []int{7}
}
...
func (*StatusUpgradeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_f0d72079fb740885, []int{8}
}
...
func (*StatusUpgradeReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_f0d72079fb740885, []int{9}
}
...
func (*UpgradeStepStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_f0d72079fb740885, []int{10}
}
...
func (*CountPerDb) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_f0d72079fb740885, []int{11}
}
...
func (*CheckObjectCountRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_f0d72079fb740885, []int{12}
}
...
func (*CheckObjectCountReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_f0d72079fb740885, []int{13}
}
...
func (*CheckVersionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_f0d72079fb740885, []int{14}
}
...
func (*CheckVersionReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_f0d72079fb740885, []int{15}
}
...
func (*CheckDiskSpaceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_f0d72079fb740885, []int{16}
}
...
func (*CheckDiskSpaceReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_f0d72079fb740885, []int{17}
}
...
func (*PrepareInitClusterRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_f0d72079fb740885, []int{18}
}
...
func (*PrepareInitClusterReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_f0d72079fb740885, []int{19}
}
...
func (*Chunk) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_f0d72079fb740885, []int{20}
}
...
type ExecuteMessage struct {
	...
	//	*ExecuteMessage_Chunk
	//	*ExecuteMessage_Status
	Contents             isExecuteMessage_Contents `protobuf_oneof:"contents"`
	XXX_NoUnkeyedLiteral struct{}                  `json:"-"`
	XXX_unrecognized     []byte                    `json:"-"`
	XXX_sizecache        int32                     `json:"-"`
}
...
func (*ExecuteMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_f0d72079fb740885, []int{21}
}
...
func (dst *ExecuteMessage) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ExecuteMessage.Merge(dst, src)
}
...
type isExecuteMessage_Contents interface {
	isExecuteMessage_Contents()
}

type ExecuteMessage_Chunk struct {
	Chunk *Chunk `protobuf:"bytes,1,opt,name=chunk,oneof"`
}
type ExecuteMessage_Status struct {
	Status *UpgradeStepStatus `protobuf:"bytes,2,opt,name=status,oneof"`
}

func (*ExecuteMessage_Chunk) isExecuteMessage_Contents()  {}
func (*ExecuteMessage_Status) isExecuteMessage_Contents() {}

func (m *ExecuteMessage) GetContents() isExecuteMessage_Contents {
	if m != nil {
		return m.Contents
	}
	return nil
...
func (m *ExecuteMessage) GetChunk() *Chunk {
	if x, ok := m.GetContents().(*ExecuteMessage_Chunk); ok {
		return x.Chunk
	}
	return nil
}

func (m *ExecuteMessage) GetStatus() *UpgradeStepStatus {
	if x, ok := m.GetContents().(*ExecuteMessage_Status); ok {
		return x.Status
	}
	return nil
}
...
func (*ExecuteMessage) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _ExecuteMessage_OneofMarshaler, _ExecuteMessage_OneofUnmarshaler, _ExecuteMessage_OneofSizer, []interface{}{
		(*ExecuteMessage_Chunk)(nil),
		(*ExecuteMessage_Status)(nil),
	}
}

func _ExecuteMessage_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*ExecuteMessage)
	// contents
	switch x := m.Contents.(type) {
	case *ExecuteMessage_Chunk:
		b.EncodeVarint(1<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Chunk); err != nil {
			return err
		}
	case *ExecuteMessage_Status:
	...
	case nil:
	default:
		return fmt.Errorf("ExecuteMessage.Contents has unexpected type %T", x)
	}
	return nil
}

func _ExecuteMessage_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*ExecuteMessage)
	switch tag {
	case 1: // contents.chunk
		...
		m.Contents = &ExecuteMessage_Chunk{msg}
		return true, err
	case 2: // contents.status
		...
		err := b.DecodeMessage(msg)
		m.Contents = &ExecuteMessage_Status{msg}
		return true, err
	default:
		return false, nil
	}
...
func _ExecuteMessage_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*ExecuteMessage)
	// contents
	switch x := m.Contents.(type) {
	case *ExecuteMessage_Chunk:
...
func (*SetConfigRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_f0d72079fb740885, []int{22}
}
...
func (*SetConfigReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_f0d72079fb740885, []int{23}
}
...
func (*GetConfigRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_f0d72079fb740885, []int{24}
}
...
func (*GetConfigReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_cli_to_hub_f0d72079fb740885, []int{25}
}
...
func init() {
	...
	proto.RegisterType((*ExecuteMessage)(nil), "idl.ExecuteMessage")
...
func (x *cliToHubExecuteClient) Recv() (*ExecuteMessage, error) {
	m := new(ExecuteMessage)
...
func (x *cliToHubExecuteServer) Send(m *ExecuteMessage) error {
...
func init() { proto.RegisterFile("cli_to_hub.proto", fileDescriptor_cli_to_hub_f0d72079fb740885) }

var fileDescriptor_cli_to_hub_f0d72079fb740885 = []byte{
	...
	,
}
